...
locals {
  ...
  _wired_entry     = try(local._pub_f.wired_services["trading-api"], null)
...
output "origin_verify_secret" {
  description = "Secret value that CloudFront sends as x-origin-verify header. Read by deploy-service.sh to wire up the CloudFront origin."
